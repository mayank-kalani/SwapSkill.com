...
const Dashboard = () => {
  ...
  const openSession = (user, isTeacher) => {
    const sessionInfo = {
          ...
          {loading ? (
            ...
            >
              {filteredUsers.map((user) => {
                ...
                const connection = acceptedReqs.find(
                ...
                return (
                  ...
                  >
                    ...
                    {isMe ? (
                      ...
                      <button
                        onClick={() => openSession(user, connection.type === "learn")}
                        className="btn-primary"
                        style={{ width: "100%" }}
                      >
                        Open Session
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          ...
          <span style={{ color: "var(--text-muted)", fontSize: 11 }}>
            Built by{" "}
            <a
              href="https://www.linkedin.com/in/mayankkalani/"
              target="_blank"
              rel="noreferrer"
              style={{ color: "#60a5fa" }}
            >
